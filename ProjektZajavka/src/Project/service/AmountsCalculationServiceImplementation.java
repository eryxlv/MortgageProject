...
public class AmountsCalculationServiceImplementation implements AmountsCalculationService {
    ...
    private RateAmounts calculateDecreasingRate(InputData inputData) {
        ...
        BigDecimal rateAmount = calculateDecreasingRateAmount();
    ...
    private BigDecimal calculateDecreasingCapitalAmount(BigDecimal amount, BigDecimal monthsDuration) {
        amount.divide(monthsDuration, 2, RoundingMode.HALF_UP);
    }

    private BigDecimal calculateQ(BigDecimal interestPercent) {

        return interestPercent.divide(YEAR, RoundingMode.HALF_UP).add(BigDecimal.ONE);
    }
